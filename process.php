...
if(isset($_POST["submitButton"])){
    ...
    $query = "INSERT INTO `salval`(`student_id`, `fname`, `mname`, `lname`, `birthday`, `email`, `number`) VALUES ('$student_id','$fname','$mname','$lname','$birthday', '$email','$number')";
    $query_result = mysqli_query( $con, $query );
...
if(isset($_POST["update"])){
    ...
    $query = "UPDATE `salval` SET `student_id`='$student_id',`fname`='$fname',`mname`='$mname',`lname`='$lname',`birthday`='$birthday',`email`='$email',`number`='$number',`date_Created`='$date_Created' WHERE `id` ='$id'";
...
if(isset($_POST["delete"])){
    ...
    $query = "DELETE FROM `salval` WHERE id = $id";
